...
class MoltBotAccessibilityService : AccessibilityService() {
    
    companion object {
        private const val TAG = "MoltBotA11y"
        var instance: MoltBotAccessibilityService? = null
            private set
    ...
    override fun onServiceConnected() {
        ...
        instance = this
        isRunning = true
        Log.d(TAG, "Accessibility Service connected - MoltBot has FULL phone control!")
    ...
    private fun executeBasicAction(actionType: String, params: Map<String, Any>): Map<String, Any> {
        return when (actionType) {
            "set_alarm" -> {
                ...
                val title = params["title"] as? String ?: "MoltBot Alarm"
