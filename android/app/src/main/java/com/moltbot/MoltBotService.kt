 ...
 */
class MoltBotService : Service() {
    
    companion object {
        private const val TAG = "MoltBotService"
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "MoltBot Service created")
    }
    
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.d(TAG, "MoltBot Service started")
    ...
    override fun onDestroy() {
        ...
        Log.d(TAG, "MoltBot Service destroyed")
    }
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, MoltBotApp.CHANNEL_ID)
            .setContentTitle("MoltBot Running")
