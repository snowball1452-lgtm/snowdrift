...
user_problem_statement: "Build a SnowDrift clone - a mobile AI assistant app with modular AI provider support (Claude, OpenAI, Gemini) using Emergent Universal Key"
