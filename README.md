# MoltBot — On-Device Android AI Agent
...
Most "AI apps" are thin wrappers around an API call. MoltBot is different.
...
```bash
git clone https://github.com/snowball1452-lgtm/moltbot_ish_fork_ish
cd moltbot_ish_fork_ish/android
...
│   └── src/main/
│       ├── java/com/moltbot/           # Kotlin — UI, services, Kotlin↔Python bridge
│       │   ├── MainActivity.kt
│       │   ├── PythonDaemonManager.kt  # Launches Python in-process (NOT subprocess)
│       │   ├── MoltBotAccessibilityService.kt
│       │   ├── PhoneActions.kt
│       │   └── ...
