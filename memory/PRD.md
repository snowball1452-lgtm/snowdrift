# MoltBot - Product Requirements Document

## Overview
MoltBot is a mobile AI assistant app (Expo/React Native) with an agentic backend (FastAPI) that can execute commands, discover tools, learn skills, and control phone actions.
